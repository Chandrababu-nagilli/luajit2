...
local OPERAND_GPR = 0x1
local OPERAND_FPR = 0x2
local OPERAND_AR = 0x4
local OPERAND_CR = 0x8
local OPERAND_DISP = 0x10
local OPERAND_BASE = 0x20
local OPERAND_INDEX = 0x40
local OPERAND_PCREL = 0x80
local OPERAND_SIGNED = 0x100
local OPERAND_LENGTH = 0x200
